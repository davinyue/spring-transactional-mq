CREATE TABLE IF NOT EXISTS TXN_MESSAGE (
    ...
    mq_type INT NOT NULL COMMENT 'MQ 类型',
    ...
    message_status INT NOT NULL COMMENT '消息状态',
    next_dispatch_time DATETIME NULL COMMENT '下次派发时间',
    parent_id VARCHAR(24) NULL COMMENT '父消息id',
    root_id VARCHAR(24) NULL COMMENT '根消息id',
