CREATE TABLE IF NOT EXISTS TXN_MESSAGE (
    ...
    original_message_id VARCHAR(24) NOT NULL COMMENT '原始消息id',
    retry_count INT NOT NULL COMMENT '已执行的消费重试次数',
    consumer_code VARCHAR(64) NULL COMMENT '消费者编码',
    last_error VARCHAR(1000) NULL COMMENT '最后消费失败信息',
    ...
    PRIMARY KEY (id),
    UNIQUE KEY uk_txn_message_original_retry (original_message_id, retry_count),
